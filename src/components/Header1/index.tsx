...
export default function Header1({ ...props }: Props) {
  return (
    <header {...props} className={`${props.className} flex w-[95%]`}>
      <div className="flex items-start justify-between gap-5 self-stretch sm:flex-col">
        <div className="mt-1 flex items-center gap-5">
          ...
          <div className="flex flex-wrap items-center">
            <Text size="3xl" as="p" className="!text-blue_gray-800_01">
              Welcome back,{" "}
            </Text>
            <Text size="3xl" as="p" className="self-start !font-racingsansone !text-blue_gray-800_01">
              John vick
            </Text>
            <a href="#">
        ...
        <div className="flex w-[21%] items-start justify-center gap-3 sm:w-full">
          <div className="flex flex-1 items-start justify-between gap-5">
            ...
            <div className="flex flex-col items-start">
              <Heading size="lg" as="h6" className="!text-blue_gray-800_01">
                Samantha
              </Heading>
          ...
          <a href="#">
            <Img src="images/img_majesticons_door_exit.svg" alt="exit image" className="mt-[5px] h-[33px] w-[34px]" />
          </a>
        </div>
      </div>
      <div className="container-xs h-px self-stretch bg-gray-50 md:p-5" />
    </header>
  );
}
